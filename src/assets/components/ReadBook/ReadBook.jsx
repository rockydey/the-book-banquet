...
const ReadBook = ({ readBook }) => {
  ...
  return (
    <section className='flex items-center gap-6 p-6 border-2 mb-6 rounded-2xl'>
      ...
      <div className='flex-grow'>
        ...
        <div className='flex gap-3 items-center'>
          ...
          <button className='text-[#FFFFFF] text-lg work-sans font-medium px-5 py-3 bg-[#23BE0A] rounded-full'>
            View Details
          </button>
        </div>
      </div>
